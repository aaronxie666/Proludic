...
public class RecyclerViewChallengeFriendsListAdapter extends RecyclerView.Adapter<RecyclerViewChallengeFriendsListAdapter.FriendsRecyclerViewHolder> {
    ...
    public RecyclerViewChallengeFriendsListAdapter(Context context, ArrayList<FriendsModel> friendsList, boolean isProfile) {
    ...
    public FriendsRecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        ViewGroup mainGroup = (ViewGroup) mInflater.inflate(R.layout.challenge_item_row_friends, viewGroup, false);
        return new FriendsRecyclerViewHolder(mainGroup);
    }

    @Override
    public void onBindViewHolder(FriendsRecyclerViewHolder holder, int position) {
        final FriendsModel model = friendsList.get(position);
...
//    add by chang start
    ...
    public void updateList(ArrayList<FriendsModel> temp) {
        friendsList = temp;
...
//    }
    ...
    class FriendsRecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextView name, username, challengeButtonInside;

        FriendsRecyclerViewHolder(View itemView) {
            super(itemView);
            this.profilePicture = (CircleImageView) itemView.findViewById(R.id.challenge_friends_profile_picture);
            this.name = (TextView) itemView.findViewById(R.id.challenge_friends_name);
            this.username = (TextView) itemView.findViewById(R.id.challenge_friends_username);
            this.challengeButtonInside = (TextView) itemView.findViewById(R.id.challenge_friends_button_inside);
