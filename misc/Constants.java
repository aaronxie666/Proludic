...
public class Constants {
    ...
    public final static String SASHIDO_APP_ID_AUS = "glbjtY86z2710bI9iVuSp4R6UBOCaVY5MMVRPShT";
    public final static String SASHIDO_CLIENT_ID_AUS = "NViz00oX6HbhwIsc2lH2Q8ixTaYUBRQgYSMMFbCP";
    public final static String SASHIDO_SERVER_ID_AUS = "https://pg-app-jy8nrp2wkljerdty2ibyugezjfjajr.scalabl.cloud/1/";
    ...
    public final static String ONE_TOUCH_WORKOUTS_KEY = "one_touch_workouts_key";
    ...
    //add by chang
    public final static String THIS_WEEK_HEARTS = "ThisWeekHearts";
    public final static String BEST_WEEK_HEARTS = "BestWeekHearts";
