...
public class AddWorkoutFragment extends Fragment {
            ...
            public void onShow(DialogInterface dialogInterface) {
                ...
                pos.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        } else if (titleIsTaken(title)) {
                            utils.makeText(getString(R.string.workout_title_taken), Toast.LENGTH_SHORT);
                        } else {
                            saveWorkout(title);
                        }
                    }
    ...
    private boolean titleIsTaken(String title) {
        ParseQuery<ParseObject> getWorkout = ParseQuery.getQuery(PRESET_WORKOUT_CLASS_NAME);
        getWorkout.whereEqualTo(WORKOUT_NAME_KEY, title);
        try {
            getWorkout.getFirst();
            return true;
    ...
    private void saveWorkout(final String title) {
                            ...
                            if (e == null) {
                                ...
                                object.saveInBackground(new SaveCallback() {
                                    ...
                                    public void done(ParseException e) {
                                        if (e == null) {
                                            dialog.dismiss();
                                            ((DashboardActivity) getActivity()).addAvailableWorkout(title);
                                            utils.makeText(getString(R.string.workout_created), Toast.LENGTH_LONG);
                                            utils.getSQLDatabase().insertCustomWorkout(title);
