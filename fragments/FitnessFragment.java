...
public class FitnessFragment extends Fragment {
    ...
    private void initViews(View view) {
        ...
        TextView btn_create_routine = (TextView) view.findViewById(R.id.create_routine);
        TextView btn_one_touch_workouts = (TextView) view.findViewById(R.id.one_touch_workout);
        btn_exercises.setOnClickListener(customListener);
        btn_workouts.setOnClickListener(customListener);
        btn_one_touch_workouts.setOnClickListener(customListener);
    ...
    //one touch workout fragment loader

    private View.OnClickListener listener = new View.OnClickListener(){

        @Override
        public void onClick(View v) {
            OneTouchWorkoutFragment frag = new OneTouchWorkoutFragment();
            FragmentTransaction trans;
            trans = getFragmentManager().beginTransaction();
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.workouts_title:
                    ...
                    break;
                case R.id.one_touch_workout:
                    trans.setCustomAnimations(R.anim.slide_in_left, R.anim.slide_out, R.anim.slide_in_left, R.anim.slide_out);
                    trans.addToBackStack(BROWSE_FRAGMENT_TAG);
                    bundle.putString(BROWSE_FRAGMENT_TAG, ONE_TOUCH_WORKOUTS_KEY);
            }
